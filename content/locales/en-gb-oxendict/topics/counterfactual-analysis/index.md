...
Without one, an observed change after a programme launches cannot be distinguished from a change that
...
"Crime fell 15% in the year after we introduced the programme" is not evidence the programme worked
unless you know what would have happened to crime without it — crime might have fallen 20% anyway due
to unrelated economic or demographic trends, meaning the programme actually made things worse relative
...
participate, not the effect of the programme. Where randomization is impractical or unethical (as it
often is for programmes with a statutory entitlement, or for whole-population policy changes), the
...
form of evidence, prone to confusing the effect of the programme with the effect of everything else
...
**Employment programme, before/after (weak design)**: a job-support scheme reports that participant
employment rose from 40% to 55% over a year — a naïve conclusion of "+15 percentage points due to the
programme."

**Same programme, difference-in-differences (stronger design)**: a matched comparison group of similar
non-participants, drawn from the same local labour market, shows employment rising from 38% to 47%
...
before/after improvement would have happened regardless of the programme, driven by the same economic
...
- Build comparison-group capture into a system from the outset — recording who was eligible but not
  enrolled, or a matched non-participant cohort — rather than retrofitting it after a programme has
...
- This is the foundational method behind [impact evaluation methods](../impact-evaluation-methods/)
  ...
  the latter of which asks whether a programme was delivered as intended rather than whether it
  caused an effect.
...
- **Treating before/after as evidence of causation.** This is the most common and most consequential
  error in public and social-sector impact reporting; a before/after change confounds the programme's
...
- **Using a comparison group that differs systematically from the treated group.** A matched
  ...
  comparing programme participants (who opted in, and are often more motivated) against non-
  participants (who did not) risks selection bias masquerading as programme effect.
