...
policy or programme actually caused, as distinct from what would have happened anyway — randomized
...
and the What Works Centre for Local Economic Growth institutionalize an evidence hierarchy built
...
can answer "did the programme cause this?" or only "did this happen after the programme started?",
...
**Local authority (difference-in-differences for a troubled families programme)**: outcome is
school attendance. The treated area moves from 84% to 89% attendance (+5 percentage points) over
the programme period; a comparable but untreated area moves from 85% to 87% (+2 percentage points)
over the same period. DiD impact estimate: 5 − 2 = +3 percentage points attributable to the
programme. Applied to a cohort of 2,000 pupils in the treated area, this is consistent with roughly
...
**Charity (propensity score matching for an employability charity)**: 300 programme participants
...
points attributable to the programme, conditional on no unobserved confounder (such as motivation)
