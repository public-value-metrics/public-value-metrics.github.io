...
mandates social value be scored as part of the tender evaluation, organised around five national
...
Bidders typically monetise their commitments against these themes using
[unit cost databases](../unit-cost-databases/), and the same monetisation logic used in
...
and 200 hours of pro bono digital-skills training for a local school, monetised using proxies from a
unit cost database at a combined £90,000 of additional social value. Bidder B commits to a smaller
package monetised at £40,000. If the authority scores social value proportionally against the
...
uses Global Value Exchange proxies to monetise its existing community employment and volunteering
commitments, making an evidenced social value case worth scoring alongside price and quality.

## Software engineering connection

Winning a bid with monetised social value commitments creates an obligation to evidence delivery
...
- **No contract management follow-through.** Commitments scored at tender are frequently never
  tracked during delivery — see [benefits realisation](../benefits-realisation/).
