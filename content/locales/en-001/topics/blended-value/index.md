...
was that this sorting was always a fiction: a grant that funds a poorly run organisation destroys
...
These are not separately optimised and then summed. A decision that maximises
...
In practice, organisations approximate the blend with a scorecard: named indicators against each
line, reported together, not netted into one number. This is the same instinct behind
[social return on investment](../social-return-on-investment/) (which does attempt monetised
