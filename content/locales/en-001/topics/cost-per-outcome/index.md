...
Cost per outcome is total programme spend divided by the number of people who achieve a defined,
...
organisations to state their outcomes before their outputs, and Inspiring Impact — the UK
...
research programme, run with Heriot-Watt University, exists precisely because parcel counts alone
...
"anyway" is not an outcome the programme bought. See [counterfactual analysis](../counterfactual-analysis/)
...
debt-advice service should use — not £15. If a comparable cash-transfer programme in the same
...
- **Denominator gaming.** Narrowing the outcome population to "those who completed the programme"
...
- **No counterfactual.** Counting anyone who achieved the outcome, including those who would have
  anyway, overstates what the programme bought. See [counterfactual analysis](../counterfactual-analysis/).
