...
built for firms optimising profit across financial, customer, internal-process, and
learning-and-growth perspectives — to organisations whose bottom line is a mission, not a margin.
...
Stewardship of        Are we using public money efficiently     Cost per outcome, budget
  resources            and within authorised limits?             variance
...
- **Copying the private-sector "financial" perspective unchanged**: a public body's stewardship
  perspective is about staying within authorised, often ring-fenced, budgets, not about maximising
