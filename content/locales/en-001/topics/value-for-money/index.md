...
**Local authority contact centre**: a council compares two options for a new case-management system.

- *Option A*: £600,000 licence (cheapest available), but agents still average 22 minutes per case
  because the workflow requires manual re-keying between systems — efficiency is poor.
- *Option B*: £900,000 licence, integrated workflow, agents average 9 minutes per case.
...
- Beware optimising procurement cost (economy) at the expense of integration and workflow efficiency,
