...
health prioritisation, and eligibility for dozens of local schemes.
...
authority funding formulae actually key off. Software that determines eligibility, prioritises
...
Each domain score: indicators standardised (ranked, then transformed
...
**LSOA composite score**, using illustrative standardised domain scores (0 = no deprivation
...
- Any service that geocodes users to postcode or LSOA can join the published IMD lookup table
  ...
  outreach, prioritising case load, or reporting outcomes by deprivation band without collecting
  new personal data.
