...
legitimacy will eventually lose the authorising environment needed to keep delivering it — funding
...
than a footnote. The OECD's "Trust in Government" survey programme is the leading cross-national
...
transaction. Governments increasingly try to operationalise legitimacy at a more granular level
...
Commission) function as institutionalised legitimacy checks, converting "does the public still
...
under-reported or poorly-categorised complaints dataset silently understates a legitimacy problem
