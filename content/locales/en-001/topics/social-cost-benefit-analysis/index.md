...
Social cost-benefit analysis converts every cost and benefit of a policy or programme — market and
...
demonstrate a positive net present social value (NPSV) wherever benefits can be credibly monetised,
...
Where SCBA breaks down is exactly where its critics expect: goods with no market analogue — clean
air, social cohesion, the value of a life saved — have to be monetised using
[stated preference](../stated-preference-valuation/) or [revealed preference](../revealed-preference-valuation/)
methods, or a [shadow price](../shadow-pricing/) has to be constructed. When monetisation is
...
where:
  Benefit_t = all monetised benefits in year t, including non-market
              goods valued via stated/revealed preference or shadow price
  Cost_t    = all monetised costs in year t, including opportunity cost
...
mandatory, not optional, because monetised non-market benefits carry wide uncertainty bands.
...
Benefits (all monetised via published DfT/WHO valuation tools):
...
**Charity**: an infant-mortality prevention programme costing £500,000/year is evaluated using the
...
instance, requires monetising benefits like reduced duplicate onboarding cost, reduced fraud, and
faster time-to-service that have no market price on their own. Engineers building the underlying
service should expect programme leads to ask for inputs to this analysis: unit costs of
...
- **Monetising the uncontested and hand-waving the contested.** If two-thirds of a proposal's
  benefit is a confidently monetised efficiency saving and one-third is a shakily monetised
