...
Public value is the worth that a government or social-sector organisation creates for citizens
collectively — not just the outputs it produces or the money it spends, but whether society is
better off because the organisation exists and acted as it did. Mark Moore's 1995 "strategic
...
authorises the budget. Moore's *Creating Public Value: Strategic Management in Government* (Harvard
...
from — a minister, a council, a mandate, a grant — and (3) whether their organisation can actually
deliver it with the people, technology, and processes at hand. A programme that scores well on only
...
in the legitimising environment — ministers, oversight committees, the public — actually wanted the
thing it optimises for. The Universal Credit digital service and the NHS National Programme for IT
...
1. Legitimacy and support: Who has authorised this, and does the authorising
...
3. Operational capacity: Can the organisation actually deliver it with
...
no engineering capacity); or authorised and deliverable but value-empty (a dashboard nobody uses).
...
authorisation for automated decisions and build monitoring capacity, or the "public value" claimed
...
- Before scoping a feature, ask who authorised it and whether that authorisation still holds — a
...
- **Treating operational capacity as sufficient justification.** "We can build it" answers only one
  leg of the triangle; teams with strong delivery capability routinely ship things nobody authorised
  wanting and that create no describable public good.
- **Conflating legitimacy with legality.** A programme can be lawful and still lack the political and
...
- Moore MH. *Creating Public Value: Strategic Management in Government*. Harvard University Press,
  1995.
- Moore MH. *Recognising Public Value*. Harvard University Press, 2013.
