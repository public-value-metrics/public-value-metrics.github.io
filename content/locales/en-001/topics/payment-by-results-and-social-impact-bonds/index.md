...
Where a SIB's social return is being modelled prospectively, that appraisal typically borrows
...
- **No credible counterfactual**: without a matched comparison group, an improvement could be
  regression to the mean or a wider trend, not the programme's effect — see
...
- **Underestimating transaction and evaluation costs**: independent verification, data linkage, and
  ...
  discontinuation.
- **Cherry-picking or "parking"**: providers paid per outcome have a direct incentive to prioritise
  clients most likely to succeed anyway and deprioritise the hardest cases — design payment tiers
