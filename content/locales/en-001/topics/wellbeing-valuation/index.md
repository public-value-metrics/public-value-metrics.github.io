...
alternative to monetising every benefit through willingness-to-pay.
...
pounds when a monetised comparison against other Green Book appraisals is needed.
...
Monetised value = Total WELLBYs × value per WELLBY
...
Monetised value = 560 × £13,000 = £7.28m
...
- **Small, self-selected samples.** Wellbeing surveys of programme participants who opted in are
  ...
  upward.
- **Treating the £-per-WELLBY conversion as precise.** The monetised value is a policy convention
