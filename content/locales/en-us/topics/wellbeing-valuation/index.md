...
What Works Center for Wellbeing, sets a recommended monetary value per WELLBY — £13,000 (2021
...
**National government**: comparing two employment programs using WELLBYs rather than earnings
...
contact. A program evaluated on earnings gain alone would understate its value relative to one
...
- **No counterfactual or comparison group.** A pre/post wellbeing gain with no control for what
  would have happened anyway overstates the program's effect; see
  [counterfactual analysis](../counterfactual-analysis/) and
  [additionality and deadweight](../additionality-and-deadweight/).
- **Small, self-selected samples.** Wellbeing surveys of program participants who opted in are
...
- HM Treasury. "Wellbeing guidance for appraisal: supplementary Green Book guidance." 2021.
  <https://www.gov.uk/government/publications/green-book-supplementary-guidance-wellbeing>
- What Works Center for Wellbeing. <https://whatworkswellbeing.org/>
