...
Targeted remediation of the worst-performing modules costs £1,200,000 and is modeled to cut interest by 70%:
...
- **"The rewrite avoids all of it"**: replacement programs must clear the same discipline as any other business case — counterfactual cost, probability of success, and discounting — not an exemption from it, as the 2013 Universal Credit restart demonstrated.
