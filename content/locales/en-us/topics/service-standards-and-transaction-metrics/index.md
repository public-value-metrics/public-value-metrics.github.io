...
metrics are the operational, day-to-day specialization of the broader public value and KPI
...
for comparable local-government services — only materializes if completion rate stays high and
...
**Illustrative central-government license-renewal service**, 2 million transactions/year,
...
- **Publishing metrics without a shared definition across services**: "transaction" and "completed"
  mean different things across different service teams unless the definitions are standardized and
