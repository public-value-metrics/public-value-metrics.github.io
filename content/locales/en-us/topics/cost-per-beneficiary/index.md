...
Cost per beneficiary is total program cost divided by the number of unique people who received
...
immediately, it is comparable across a portfolio of very different programs, and it is honest
...
```
Cost per beneficiary = Total program cost / Number of unique people served

Contrast:
Cost per outcome      = Total program cost / Number of people achieving the defined outcome
...
(sustained employment at 6 months) = £11,000, because only 18% of enrolees complete the program
...
- **Double counting across programs.** A person receiving both food parcels and debt advice from
