...
budget, every pound spent on one program is a pound that cannot be spent on the next-best
program — the true cost of a decision is not what it spends, but what it displaces.
...
single business case. A £2 million grant program for youth employment is compared, in the business
...
discipline generalizes: identify the realistic next-best use of the same budget line (not an
idealized "do nothing"), value it on the same basis (monetized where possible, per
...
- *Option A*: a new case-management platform, monetized benefit £7.2 million over 5 years
  (efficiency savings plus faster case resolution).
- *Option B*: an identity-verification service shared across three departments, monetized benefit
...
- Connect this directly to [value for money](../value-for-money/): VFM's "economy" test is
  ...
  [cost of delay in public programs](../cost-of-delay-in-public-programmes/), which prices the
...
- **Ignoring cross-departmental competition for the same pot.** Budget lines that look ring-fenced
  within one directorate often compete at a higher level (a spending review, a capital program)
  where the real opportunity cost is realized.
