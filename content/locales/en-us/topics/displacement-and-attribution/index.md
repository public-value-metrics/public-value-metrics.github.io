...
Displacement occurs when a program's apparent benefit is achieved by taking activity or benefit
...
evaluation guidance (used for former EU Regional Development Fund programs and their domestic
...
at a wider one — a jobs program that draws workers from a neighbouring town is nationally neutral
...
sector and cross-agency public service work. When three organizations jointly deliver a
homelessness-prevention service, each organization's annual report may independently claim credit
...
**Multi-agency homelessness service**: three partner organizations (a council, a housing charity, and
a health trust) jointly deliver a rough-sleeping reduction service. Rough sleeping in the area fell by
30 people over the year. Each organization's individual annual report claims "we reduced rough
...
- Geographic and organizational scope should be explicit, first-class fields in any impact dashboard
...
- **Reporting local success without checking wider displacement.** A program can look highly
