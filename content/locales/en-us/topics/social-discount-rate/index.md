...
programs with payoffs spread across decades can be compared on a common basis. HM Treasury's Green
...
any long-horizon benefit — a flood defense saving lives in 80 years, a carbon reduction avoiding
...
benefit. The disagreement was not about the math; it was about whose ethical framework should set
...
**Flood defense scheme**: a project delivers £10 million of avoided flood damage in year 40.
...
investment with a long asset life (a national platform, a data infrastructure program, a
...
- For benefits realized many years out (a platform's long-term maintenance savings, an open-data
...
- **Treating the discount rate as ethically neutral.** The Stern-Nordhaus dispute shows the rate
  encodes a value judgement about future generations; changing it changes which programs look
