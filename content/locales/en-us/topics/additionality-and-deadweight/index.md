...
without the program, grant, or subsidy. Almost every impact claim from a government program or
...
routes, because they were already on a growth trajectory before the program started — the
program's true additional contribution is 200, not 500. HM Treasury's Magenta Book and the
long-standing HM Treasury/BIS "Additionality Guide" (developed originally for regional development
and regeneration programs, and widely used across UK government evaluation since) formalize
...
inflated, deliberately or not — a grant program that only measures gross participant outcomes,
...
credible program evaluations report a deadweight-adjusted range rather than a single assumed
...
**Business-support grant program**: a regional grant scheme reports 500 supported businesses
...
The program's honestly reportable achievement is 900 jobs, not 1,500 — a 40% reduction purely from
the deadweight adjustment, before displacement or leakage are even considered.

**Charity employment program**: a charity places 200 long-term unemployed people into jobs at a
cost of £600,000 (£3,000 per placement, gross). National labor-market data shows that, absent any
...
- **Reporting gross outcomes as if they were all additional.** This is the single most common impact-
  measurement error in grant and program reporting; always ask "would this have happened anyway?"
...
- **Self-reported deadweight from participants.** Asking beneficiaries "would this have happened
  ...
  the program); an independent comparison group is far more reliable.
