...
money people spend traveling to a site reveals a lower bound on what the site is worth to them,
...
practitioners realize: usage data from a free government digital service is itself
revealed-preference evidence of value (frequency, session length, and — most tellingly —
repeat-versus-one-off usage patterns can be analyzed the same way a travel-cost model treats visit
...
- **Omitted variable bias in hedonic models.** Leaving out a correlated attribute (school quality
  ...
  price estimate; specification needs to be reported and scrutinized, not just the result.
