...
Decision drivers, in the order they usually decide:
  ...
  2. time-to-value × cost of delay (see cost-of-delay-in-public-programs.md)
...
- **Zero-priced internal labor**: civil service engineering time is treated as "free" because it is already on the departmental headcount budget, which hides its true opportunity cost against other work that team could be doing.
