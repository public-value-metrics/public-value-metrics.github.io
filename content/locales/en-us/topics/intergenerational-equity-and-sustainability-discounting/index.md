...
δ ≈ 0.1%, reflecting only the small probability of civilization-ending catastrophe, not a genuine
...
- Any long-horizon appraisal or business-case tool (infrastructure, climate adaptation, pension
  modeling) should implement the Green Book's *declining* schedule, not a single flat rate — a
...
- Where a program's benefits are explicitly intergenerational (flood defense, natural capital
