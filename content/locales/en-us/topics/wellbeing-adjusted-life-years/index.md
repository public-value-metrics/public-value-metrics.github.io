...
one person for one year. It is the structural analog of the QALY used in health economics — a
...
with other approaches to the value of a life year, giving appraisers a way to monetize outcomes —
...
Against an annual program cost of £300,000 (£600,000 over 2 years), the benefit-cost ratio is
...
**Charity, smaller scale**: a community arts program reaches 50 participants with a measured
...
- WELLBYs give engineering teams building for [social value act](../social-value-act/) reporting or
  [social return on investment](../social-return-on-investment/) a nationally standardized,
