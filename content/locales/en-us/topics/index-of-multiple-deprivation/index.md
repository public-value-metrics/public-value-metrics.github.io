...
input, not an afterthought — and where a program deliberately targets the most deprived areas,
...
- **Ignoring domain-level detail in favor of the composite rank** — two LSOAs with identical
