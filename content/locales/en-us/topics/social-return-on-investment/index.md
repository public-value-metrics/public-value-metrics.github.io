...
Social return on investment is a framework for measuring, monetizing, and accounting for a broad
...
**Local authority employment program**: annual input cost £250,000. Sixty participants move into
...
- Less deadweight (40% would likely have found work without the program): £510,000 × 0.60 = £306,000
...
- **Comparing ratios across organizations.** An SROI ratio depends on scope and proxy choices made
  case by case; treating a 4:1 ratio from one report as "better" than a 2:1 ratio from another
  ignores that the assumptions are not standardized like a financial accounting ratio.
