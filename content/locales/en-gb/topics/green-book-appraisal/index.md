...
2. Economic case
   ...
   Test: which option maximises net public value?
...
5. Management case
   Governance, project plan, benefits realisation plan, risk register.
   Test: can this organisation actually deliver it?
   See ../benefits-realisation/
```
...
be honestly monetised, via [cost-effectiveness analysis](../cost-effectiveness-analysis-in-government/)
...
Engineering teams inside government or grant-funded organisations usually only ever see the
...
case's output is usually summarised, and [total cost of ownership](../total-cost-of-ownership-in-government-it/)
...
- **Skipping the commercial and management cases because the economic case is strong.** A high
  NPV proposal that cannot be procured competitively or delivered by the sponsoring organisation is
